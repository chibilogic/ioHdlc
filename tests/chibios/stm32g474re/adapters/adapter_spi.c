...
/* SPIv2 on STM32G4 requires the frame size to be programmed explicitly. */
#define TEST_SPI_ADAPTER_CFG_A_CR2  (SPI_CR2_DS_2 | SPI_CR2_DS_1 | SPI_CR2_DS_0)
#define TEST_SPI_ADAPTER_CFG_B_CR2  (SPI_CR2_DS_2 | SPI_CR2_DS_1 | SPI_CR2_DS_0)
