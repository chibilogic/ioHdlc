...
/*
 * Local board package for the ioHdlc G474 frontend.
...
#define GPIOA_LPUART1_TX            GPIOA_STLINK_TX
#define GPIOA_LPUART1_RX            GPIOA_STLINK_RX
#define GPIOA_SPI1_NSS              GPIOA_PIN4
#define GPIOA_SPI_DR_A              GPIOA_PIN8
...
#define GPIOB_SPI1_SCK              GPIOB_TRACESWO
#define GPIOB_SPI1_MISO             GPIOB_PIN4
#define GPIOB_SPI1_MOSI             GPIOB_PIN5
#define GPIOB_SPI_DR_B              GPIOB_PIN10
#define GPIOB_SPI2_NSS              GPIOB_PIN12
#define GPIOB_SPI2_SCK              GPIOB_PIN13
#define GPIOB_SPI2_MISO             GPIOB_PIN14
#define GPIOB_SPI2_MOSI             GPIOB_PIN15
...
#define GPIOC_USART3_TX             GPIOC_PIN10
#define GPIOC_USART3_RX             GPIOC_PIN11
...
#define LINE_SPI_DR_A               PAL_LINE(GPIOA, 8U)
...
#define LINE_SPI_DR_B               PAL_LINE(GPIOB, 10U)
 ...
 * PA0  - PIN0                      (analog).
 * PA1  - PIN1                      (analog).
 * PA2  - STLINK_TX LPUART1_TX      (alternate 12).
 * PA3  - STLINK_RX LPUART1_RX      (alternate 12).
 * PA4  - SPI1_NSS                  (output pushpull high).
 * PA5  - LED LED_GREEN             (output pushpull maximum).
 * PA6  - PIN6                      (analog).
 * PA7  - PIN7                      (analog).
 * PA8  - SPI_DR_A                  (input pulldown).
...
#define VAL_GPIOA_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOA_PIN0) |       \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOA_SPI_DR_A) |   \
...
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_VERYLOW(GPIOA_PIN0) |       \
                                     ...
                                     PIN_OSPEED_VERYLOW(GPIOA_LPUART1_TX) | \
                                     PIN_OSPEED_VERYLOW(GPIOA_LPUART1_RX) | \
                                     PIN_OSPEED_MEDIUM(GPIOA_SPI1_NSS) |    \
                                     PIN_OSPEED_HIGH(GPIOA_LED) |           \
                                     PIN_OSPEED_VERYLOW(GPIOA_PIN6) |       \
                                     PIN_OSPEED_VERYLOW(GPIOA_PIN7) |       \
                                     PIN_OSPEED_VERYLOW(GPIOA_SPI_DR_A) |   \
...
#define VAL_GPIOA_PUPDR             (PIN_PUPDR_FLOATING(GPIOA_PIN0) |       \
                                     ...
                                     PIN_PUPDR_PULLDOWN(GPIOA_SPI_DR_A) |   \
...
#define VAL_GPIOA_AFRL              (PIN_AFIO_AF(GPIOA_PIN0, 0U) |          \
                                     ...
                                     PIN_AFIO_AF(GPIOA_LPUART1_TX, 12U) |   \
                                     PIN_AFIO_AF(GPIOA_LPUART1_RX, 12U) |   \
                                     PIN_AFIO_AF(GPIOA_SPI1_NSS, 0U) |      \
                                     PIN_AFIO_AF(GPIOA_LED, 0U) |           \
                                     PIN_AFIO_AF(GPIOA_PIN6, 0U) |          \
                                     PIN_AFIO_AF(GPIOA_PIN7, 0U))
#define VAL_GPIOA_AFRH              (PIN_AFIO_AF(GPIOA_SPI_DR_A, 0U) |      \
 ...
 * PB1  - PIN1                      (analog).
 * PB2  - BOOT1                     (analog).
 * PB3  - TRACESWO SPI1_SCK         (alternate 5).
 ...
 * PB8  - PIN8                      (analog).
 * PB9  - PIN9                      (analog).
 * PB10 - SPI_DR_B                  (output pushpull low).
 * PB11 - PIN11                     (analog).
...
#define VAL_GPIOB_MODER             (PIN_MODE_ANALOG(GPIOB_PIN0) |          \
                                     ...
                                     PIN_MODE_OUTPUT(GPIOB_SPI_DR_B) |      \
...
#define VAL_GPIOB_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOB_PIN0) |       \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOB_SPI_DR_B) |   \
...
#define VAL_GPIOB_PUPDR             (PIN_PUPDR_FLOATING(GPIOB_PIN0) |       \
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOB_SPI_DR_B) |   \
...
#define VAL_GPIOC_OSPEEDR           (PIN_OSPEED_VERYLOW(GPIOC_PIN0) |       \
                                     ...
                                     PIN_OSPEED_MEDIUM(GPIOC_USART3_TX) |   \
                                     PIN_OSPEED_MEDIUM(GPIOC_USART3_RX) |   \
