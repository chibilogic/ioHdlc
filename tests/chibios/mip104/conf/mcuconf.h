...
#define SAMA_SD0_USE_GCLK                   FALSE
#define SAMA_SD0_GCLK_SOURCE                SAMA_GCLK_MCK_CLK
#define SAMA_SD0_GCLK_DIV                   11

#define SAMA_SERIAL_USE_UART1               TRUE
#define SAMA_SD1_USE_GCLK                   TRUE
#define SAMA_SD1_GCLK_SOURCE                SAMA_GCLK_MCK_CLK
#define SAMA_SD1_GCLK_DIV                   11

#define SAMA_SERIAL_USE_UART2               FALSE
#define SAMA_SD2_USE_GCLK                   FALSE
#define SAMA_SD2_GCLK_SOURCE                SAMA_GCLK_MCK_CLK
#define SAMA_SD2_GCLK_DIV                   11

#define SAMA_SERIAL_USE_UART3               FALSE
#define SAMA_SD3_USE_GCLK                   FALSE
#define SAMA_SD3_GCLK_SOURCE                SAMA_GCLK_MCK_CLK
#define SAMA_SD3_GCLK_DIV                   11

#define SAMA_SERIAL_USE_UART4               FALSE
#define SAMA_SD4_USE_GCLK                   FALSE
#define SAMA_SD4_GCLK_SOURCE                SAMA_GCLK_MCK_CLK
#define SAMA_SD4_GCLK_DIV                   11
 ...
 */
#define UART_DRIVER_EXT_FIELDS              void *ip;
