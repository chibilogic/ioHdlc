...
/**
 * @brief   Enables the USB HOST subsystem.
 */
#if !defined(HAL_USE_USB_HOST) || defined(__DOXYGEN__)
#define HAL_USE_USB_HOST                    FALSE
#endif
...
/** @brief Back reference used by the ioHdlc SPI backend. */
#define SPI_DRIVER_EXT_FIELDS               void *ip;
