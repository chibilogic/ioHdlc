...
/**
 * @brief   Get ioHdlcStream interface from adapter.
 * @param[in] adapter   Adapter instance
 * @return              Pointer to ioHdlcStream structure
 */
ioHdlcStream* mock_stream_adapter_get_stream(mock_stream_adapter_t *adapter);
