...
/*
 * CRC/X-25 Table.
 * The CRC/X-25 is a table with the bits in reversed order, to account the fact
 * that the LSB of any octet is transmitted first, while the FCS shall be
 * transmitted to the line commencing with the coefficient of the highest term.
 *
 * See table generator snippet at the end of this file.
 */
...
#if 0
/*
 * Generate a FCS-16 bit reversed table.
 *
